...
function FileInputView({ sharedParams, tarjetonType }) {
   ...
   let footerUrlLink = tarjetonType === "GENERIC" || tarjetonType === "AREA" || tarjetonType === "EVENT" ?
      FUNIBER_URL_LINKS[sharedParams.sede] : "https://www.funiber.es/";
   ...
   let handleSubmit = (e) => {
      ...
      checkParams(sede, pixel, finalLink, bannerLink, buttonLink, footerLink);
      setShowResult(true);
   };
